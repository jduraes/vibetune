...
- **Reference on same box (F3>, 08-Jun-2026):** `vtune rl2wof` → timer mode; `vtune rl2wof -delay` → delay mode. Confirms current startup timing selection is correct on SC126 / RCZ180 EB.
